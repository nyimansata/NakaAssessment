first i create a searchBar where users can search for any recipe and then i itarate through an array to display the different recipes that are availabe.
